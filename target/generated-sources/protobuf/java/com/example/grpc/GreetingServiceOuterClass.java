...
public final class GreetingServiceOuterClass {
  ...
  public interface HelloRequestOrBuilder extends
    ...
    /**
     * <pre>
     *это тег (целое число). Пересылаемый ключ - единица. Когда на сервере будет приниматься ключ 1, он будет сопоставляться с ключем name
     * </pre>
     *
    ...
    /**
     * <code>repeated string request = 2;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < request_.size(); i++) {
        com.google.protobuf.GeneratedMessageV3.writeString(output, 2, request_.getRaw(i));
      }
